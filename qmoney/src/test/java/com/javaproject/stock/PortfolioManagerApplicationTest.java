...
public class PortfolioManagerApplicationTest {
    ...
    void mainCalculateAnnualReturn() throws Exception {
        ...
        String filename = "trades.json";
        //when
        List<AnnualizedReturn> result = PortfolioManagerApplication.mainCalculateSingleReturn(new String[]{filename, "2019-12-12"}, IFilePathLocator.MAIN_JAVA_RESOURCE);
    ...
    public void testCalculateAnnualizedReturn() {
        ...
        AnnualizedReturn returns = PortfolioManagerApplication.calculateAnnualizedReturns(LocalDate.parse("2018-01-01"), trade, 10000.00, 11000.00);
    ...
    public void testCalculateAnnualizedReturnGoogl() {
        ...
        AnnualizedReturn returns = PortfolioManagerApplication.calculateAnnualizedReturns(LocalDate.parse("2019-12-12"), trade, 1054.00, 1348.00);
